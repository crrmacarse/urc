...
$username_err = $fName_err = $lName_err = $email_err = $password_err = $confirm_password_err = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty(trim($_POST["lName"]))) {
        $lName_err = "Please your enter last name.";
    } else {
    ...
    if (empty($username_err) && empty($fName_err) && empty($lName_err) && empty($email_err) && empty($password_err) && empty($confirm_password_err)) {
        ...
        if ($stmt = mysqli_prepare($conn, $sql)) {
            mysqli_stmt_bind_param($stmt, "sssss", $param_username, $param_fName, $param_lName, $param_email, $param_password);
